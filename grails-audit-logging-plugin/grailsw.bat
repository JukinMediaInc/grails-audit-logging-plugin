...
set AGENT_STRING=-javaagent:grailsWrapper/springloaded-1.2.0.RELEASE.jar -noverify -Dspringloaded.synchronize=true -Djdk.reflect.allowGetCallerClass=true -Dspringloaded=\"%SPRINGLOADED_PARAMS%\"
...
set STARTER_CLASSPATH=grailsWrapper/grails-wrapper-runtime-2.3.11.jar;grailsWrapper;.
